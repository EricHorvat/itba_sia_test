...
public class HeuristicGPSTests {
	...
	public static void setUp(){
		E8Problem betterHeuristicProblem = new E8Problem(false, E8HeuristicA.instance());
		E8Problem worseHeuristicProblem = new E8Problem(false, E8HeuristicB.instance());
		betterHeuristicEngine = new GPSEngine(betterHeuristicProblem , SearchStrategy.ASTAR);
		worseHeuristicEngine = new GPSEngine(worseHeuristicProblem, SearchStrategy.ASTAR);
